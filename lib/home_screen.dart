...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    // If user data is not loaded yet, you can fetch it here
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      // User Profile with Gesture Detector
                      GestureDetector(
                        onTap: () => _viewProfile(context),
                        onLongPress: () => _handleLogout(context),
                        child: Container(
                          width: 40,
                          height: 40,
                          decoration: BoxDecoration(
  ...
  // Helper method for building produce cards

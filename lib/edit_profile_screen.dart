...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  // Image related variables - Use XFile instead of File for web compatibility
  ...
  Future<void> _pickImage() async {
    ...
    if (image != null) {
      // Read the bytes for web compatibility
        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  // Profile Photo Section - Web Compatible
                  Container(
  ...
  // Helper method to build profile image - web compatible

...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // If we have a recipient from product details, we might want to auto-open chat
    if (widget.recipientId != null && widget.recipientName != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        Navigator.push(
          ...
          // Reset the parameters after navigation
    ...
    return Scaffold(
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          // Secondary FAB for filtering by status
          Container(
            ...
            child: Row(
              ...
              children: [
                _buildStatusFilterChip('All', 0, isDarkMode),
                _buildStatusFilterChip('In Progress', 1, isDarkMode),
                _buildStatusFilterChip('Completed', 2, isDarkMode),
              ],
            ),
          ),
        ],
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            '$unreadCount unread · ${_chats.length} total',
                            style: TextStyle(
                              fontSize: 14,
  ...
  Widget _buildStatusFilterChip(String label, int index, bool isDarkMode) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // User Avatar with Online/Unread Indicator
            Stack(
              children: [
                Container(
                  width: 56,
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: chat['unread'] == true
                          ? Color(0xFF29A366)
                          : (isDarkMode ? Color(0xFF1F2E23) : Colors.white),
                      width: chat['unread'] == true ? 3 : 2,
                    ),
                ...
                if (index == 0) // Online indicator for first chat
                  Positioned(
                    bottom: 0,
                    right: 0,
                    child: Container(
                ...
                if (chat['unread'] == true) // Unread indicator
                  Positioned(
                    top: 0,
                    right: 0,
                    child: Container(
